  ...
  "internship": [
    {
      ...
      "description": [
        "AI效率优化：针对重复性工作痛点，自主开发三个AI工具实现流程智能化改造。构建批量数据转换工具（腾讯在线文���→LMS自动转换，处理时间3小时→10分钟，效率提升95%）；采用LPT贪心算法构建智能任务分配系统（周处理时间3小时→30分钟，效率提升83%）；开发AI话术生成器（确认时间5分钟→10秒，效率提升96%）。相关工具代码已开源至<a href=\"https://ty-11lyh.github.io/my-tools/\" target=\"_blank\">GitHub</a>",
